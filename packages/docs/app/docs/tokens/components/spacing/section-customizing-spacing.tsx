...
export const SectionCustomizingSpacing = memo(function SectionCustomizingSpacing() {
  return (
    <>
      <Section
        ...
        content={
          <>
            <p>
              You can customize the spacing scale by adding or removing values. The spacing()
              function will automatically adjust to the new scale.
            </p>
          </>
        }
      >
        <SpacingGrid>
          {[
            ...
            <Fragment key={key}>
              ...
              <SpacingValue>{key === "px" ? "-" : `${Number(key) / 4}rem`}</SpacingValue>
