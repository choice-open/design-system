...
export const SectionOverviewSemanticColors = memo(function SectionOverviewSemanticColors() {
  ...
  return (
    <Section
      ...
      content={
        <p>
          Semantic color tokens provide consistent, context-aware color choices that adapt
          automatically to different themes. These tokens abstract away specific color values and
          focus on the intended use case, making your designs more maintainable and theme-ready.
        </p>
      }
    >
      <PanelHeader>
