...
describe("颜色令牌测试", () => {
  ...
  describe("W3C 格式验证", () => {
    ...
    it("应该包含颜色分类信息", () => {
      ...
      if (blue500.$extensions && blue500.$extensions["choiceform.design-system"]) {
        expect(blue500.$extensions["choiceform.design-system"]).toHaveProperty("category")
        expect(blue500.$extensions["choiceform.design-system"].category).toBe("hues")
      }
    })
  })
