import { forwardRef, useMemo, useId, ComponentPropsWithoutRef } from "react"
...
export const FileUploadItem = forwardRef<HTMLDivElement, FileUploadItemProps>((props, forwardedRef) => {
